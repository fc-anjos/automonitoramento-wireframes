...
export const datasets = {
  ...
  processos: {
    ...
    fields: {
      ...
      outorgado: field('Outorgado'),
      fase: field('Fase'),
      instancia: field('Instância'),
      grau: field('Grau'),
      penalidade: field('Penalidade'),
      reincidencia: field('Reincidência'),
      ciencia: field('Ciência'),
      dataCiencia: field('Data de ciência', 'date'),
      dataLimiteDefesa: field('Prazo de defesa', 'date'),
      dataLimiteDecisao: field('Prazo de decisão', 'date'),
      guia: field('Guia'),
      financeiro: field('Financeiro'),
      regularizacao: field('Regularização'),
      enquadramento: field('Enquadramento'),
      tipoFato: field('Tipo do fato'),
      decisao: field('Decisão administrativa'),
      prazo: field('Prazo', 'deadline'),
      proximaAcao: field('Próxima ação'),
    },
    relations: {
  ...
  multas: {
    ...
    fields: {
      ...
      outorgado: field('Outorgado'),
      valor: field('Valor'),
      valorEsperado: field('Valor esperado'),
      valorPago: field('Valor pago'),
      vencimento: field('Vencimento'),
      situacao: field('Situação'),
      guiaEstado: field('Estado da guia'),
      conciliacaoEstado: field('Estado da conciliação'),
      cobrancaEstado: field('Estado de cobrança'),
      conciliacao: field('Conciliação'),
      pagamento: field('Pagamento'),
      retornoArrecadador: field('Retorno arrecadador'),
      dataRetorno: field('Data do retorno'),
      arrecadador: field('Arrecadador'),
      documentoArrecadacao: field('Documento de arrecadação'),
      codigoReceita: field('Código de receita'),
      proximaAcao: field('Próxima ação'),
    },
    relations: {
      processo: { label: 'Processo', to: 'processos', localField: 'processo', foreignField: 'id' },
      uso: { label: 'Uso', to: 'usos', localField: 'uso', foreignField: 'id' },
    },
  },
  evidenciasProcessuais: {
    label: 'Evidências processuais',
    rows: evidenciasProcessuais,
    fields: {
      id: field('Evidência'),
      processo: field('Processo'),
      tipo: field('Tipo'),
      ...
      origem: field('Origem'),
      estado: field('Estado'),
      congeladoEm: field('Congelado em'),
      integridade: field('Integridade'),
    },
    relations: {
      processo: { label: 'Processo', to: 'processos', localField: 'processo', foreignField: 'id' },
    },
