        ...
        <div className="phone-stage" style={{ justifyContent: 'center' }}>
          ...
          <div>
            ...
            <Note style={{ maxWidth: 340, margin: '16px auto 0' }}>
              O relógio do prazo de defesa só corre a partir da <b>ciência</b>, e o envio da defesa devolve um <b>protocolo com recibo</b>, que fica no histórico do processo. O pacote de evidência foi <b>congelado na lavratura</b>: o que você contesta é exatamente o que o gestor viu.
            </Note>
          ...
          {/* MOMENT 2: decisão publicada, recurso em prazo, cumprimento ao vivo */}
          <div>
            <Phone>
              <Notch />
              <StatusBar right="▰▰▱ 4G ▮" />
              <PScroll>
                ...
                {/* CUMPRIMENTO: guia ao vivo + correção, os dois lado a lado */}
                  ...
                  <Body>
                    <div className="mrow">
                      ...
                      <div className="msp">
                        ...
                        <div className="faint" style={{ fontSize: 11 }}>situação atualizada por conciliação bancária, nunca à mão</div>
                      </div>
            ...
            <PhoneLabel>Decisão, recurso e cumprimento ao vivo</PhoneLabel>

            <Note style={{ maxWidth: 340, margin: '16px auto 0' }}>
              A situação da guia muda por <b>conciliação bancária</b>; ninguém marca "pago" à mão. Cada ato seu (ciência, defesa, recurso) devolve um <b>recibo</b> e entra na trilha de auditoria, que nunca é apagada.
            </Note>
            <Note style={{ maxWidth: 340, margin: '12px auto 0', fontSize: 12 }}>
