...
const FILA = [
  ...
  { codigo: '07-0712', nome: 'Laticínios Itanhaém', protocolo: 'AP-0712-A', apontamento: 'Calibração do hidrômetro vencida', natureza: 'Exceção', tipo: 'Condicionante', grau: 'leve', grauVar: 'warn', fase: 'Notificada', prazo: 'recalibrar até 30/06', dono: 'outorgado', proxima: 'Aguardar recalibração credenciada' },
